...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('registro')->group(function () {
        ...
        Route::post('/asistencias', [RegistroController::class, 'registerAsistencia']);
        ...
        Route::get('/count/{fechaDesde?}/{fechaHasta?}', [EstadisticaController::class, 'GetResumenData']);
        Route::get('/fe-vida-count/{tipoEmpleado?}/{fechaDesde}/{fechaHasta}', [EstadisticaController::class, 'GetResumenDataFeDeVida']);
        ...
        Route::get('/get_per_x_unid/{unid}/{voto_status}/{fechaDesde?}/{fechaHasta?}', [EstadisticaController::class, 'filterPersonasXUnid']);
    ...
    "exception": "Error",
    "file": "/var/www/html/app/Http/Services/Const/PersonaFotoService.php",
    "line": 68,
    "trace": [
        {
    CHUPALA
        */
        ...
        Route::get('/registroAsistencia', [ConstController::class, 'obtenerRegistrosAsistencia']);

        Route::post('foto-persona/{id}', [ConstController::class, 'guardarFoto']);
