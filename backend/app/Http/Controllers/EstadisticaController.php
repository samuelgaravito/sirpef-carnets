...
public function tiposEmpleadoDelUsuario()
{
    return \App\Http\Services\Statistic\FiltroMinisterioService::tiposEmpleadoDelUsuario(); 
}
...
public function GetResumenData($fechaDesde = null, $fechaHasta = null)
{
    return EstadisticaParticipacionService::GetResumenData($fechaDesde, $fechaHasta );      
}
...
public function GetResumenDataFeDeVida(Request $request)
{
    $tipoEmpleado = $request->query('tipoEmpleado');
    $fechaDesde = $request->query('fechaDesde');
    $fechaHasta = $request->query('fechaHasta');

    return EstadisticaParticipacionFeDeVidaService::GetResumenDataFeDeVida($tipoEmpleado, $fechaDesde, $fechaHasta);
}
...
public function filterPersonasXUnid($unid, $voto_status,$fechaDesde = null, $fechaHasta = null) {
    return FiltroPersonaUnidadService::filterPersonasXUnid($unid, $voto_status, $fechaDesde, $fechaHasta );
}
