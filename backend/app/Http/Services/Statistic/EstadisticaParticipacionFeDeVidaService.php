...
{
    static public function GetResumenDataFeDeVida($tipoEmpleado = null,$fechaDesde = null, $fechaHasta = null)
{
    $user = auth()->user();
    if (!$user) {
    ...
    // Filtrar por tipo_empleado si se proporciona
    if ($tipoEmpleado !== null) {
        $personasQuery->where('tipo_empleado_id', $tipoEmpleado);
    }
    ...
    // Filtrar por votos "true" presenciales
    ...
    // Filtrar por votos "true" por correo
