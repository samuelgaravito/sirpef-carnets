...
<template>
<div id="Tbl_dash_popup" class="relative overflow-x-auto rounded-xl">
...
#Tbl_dash_popup .dt-paging button.current, #Tbl_dash_popup .dt-paging button:hover, #Tbl_dash_popup .dt-buttons button:hover{
  background-color: #010c41;
  color: white;
  border: #010c41;
  scale: 1.2;
