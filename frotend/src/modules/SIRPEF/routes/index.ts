...
export default [
  ...
  {
    path: "/finger/:ci?",
    name: "asistenciasfinger",
    meta: { middleware: [whitEvent, auth] },
    component: () => import("../views/Participacion/huellas.vue").then(m => m.default)
  },
  ...
  {
    path: "/asistencia",
    name: "asistenciaRegister",
    meta: { middleware: [auth]},
    component: () => import("../../Personal/views/registroAsistencia.vue").then(m => m.default)
  },
