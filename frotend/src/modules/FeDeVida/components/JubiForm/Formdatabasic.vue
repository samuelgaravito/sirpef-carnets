...
const validateTelefono2 = () =>  {
    props.values.telefono_2 = props.values.telefono_2.replace(/\D/g, '');
}
    ...
    <form @submit.prevent="emitForm">
        ...
        <div class="lg:grid-cols-2 lg:grid my-5 gap-x-10">
            ...
            <div>
                ...
                <input class="inputForm" type="text" name="telefono" maxlength="11" placeholder="Ingrese su celular" @input="validateTelefono" v-model="values.telefono" required>
            </div>
        </div>


        <div>
                <label class="block my-2">Teléfono 2</label>
                <input class="inputForm" type="text" name="telefono2" maxlength="11" placeholder="Ingrese su celular (Opcional)" @input="validateTelefono2" v-model="values.telefono_2">
            </div>

        <div class="grid-cols-1 lg:grid my-5 gap-x-10">
            <div>
